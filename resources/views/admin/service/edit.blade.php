...
<div class="content-body" style="min-height: 788px;">
        ...
        <form method="post" action="{{ route('service.update',[$service->id]) }}" enctype="multipart/form-data">
         ...
         <input type="text" name="name" class="form-control input-default " value="{{$service->service_name}}" >
            @error('name')
         ...
         <textarea class="form-control" name='description' rows="4" id="comment">{{$service->service_description}}</textarea>
