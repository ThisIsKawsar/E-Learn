...
<div class="content-body" style="min-height: 788px;">
       ...
       <form method="post" action="{{ route('project.store') }}" enctype="multipart/form-data">
        ...
        <input type="file" name="img_two" class="custom-file-input" id="image">
            ...
            <div class="form-group">
               <img id="showImage" src="{{(!empty($project->img_one))?url('upload/images/'.$project->img_one):url('upload//no_image.jpg')}}" class="img-fluid rounded-circle" alt="" style="width: 100px; height: 100px;">
            </div>
